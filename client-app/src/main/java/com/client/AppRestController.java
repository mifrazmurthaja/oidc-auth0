...
public class AppRestController {
    ...
    String jwt_head = null;
    String jwt_body = null;
    String jwt_sig = null;
    ...
    @RequestMapping("/id_token")
    public String getIdToken() {

        String id_token = "{\"HEADER\":"+this.jwt_head +
                            ",\"PAYLOAD\":"+this.jwt_body + "}";
        return id_token;
    }
    ...
    public JSONObject getUserData(String response)
    {
        ...
        try{
            ...
            //Decode the retrieved base64 encoded head,body and signature
            this.jwt_head = new String(base64Url.decode(headEnc));
            this.jwt_body = new String(base64Url.decode(bodyEnc));
            this.jwt_sig = new String(base64Url.decode(sigEnc));

            //Convert the body string to json object and retrieve user data
            bodyJson = new JSONObject(this.jwt_body);
        }
        catch(Exception ex){
            System.out.println(ex);
        }
